import { getApplicationStatusLabel } from "@/lib/application-statuses";
...
export default function Badge({ children, variant }) {
  ...
  const variantClasses = {
    ...
    OFFER_DECLINED: 'bg-orange-50 text-orange-600 ring-1 ring-orange-100',
  ...
  return (
    <span className={`${baseClasses} ${variantClasses}`}>
      {getApplicationStatusLabel(variant, children)}
    </span>
  );
}
