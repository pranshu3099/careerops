  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <div
          className={`px-4 py-5 flex items-center ${isCollapsed ? "justify-center" : "justify-between"}`}
        >
          {!isCollapsed && (
            <div className="flex items-center gap-2.5">
              ...
              <Link
                href="/dashboard"
                className="text-base font-bold tracking-tight text-slate-800 cursor-pointer"
              >
                CareerOps
              </Link>
            </div>
            ...
            {navItems.map((item) => {
              ...
              return (
                <li key={item.label}>
                  ...
                  >
                    <Icon
                      className={`w-4.5 h-4.5 flex-shrink-0 ${isActive ? "text-indigo-600" : ""}`}
                    />
