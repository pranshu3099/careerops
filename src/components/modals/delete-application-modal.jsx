      ...
      >
        <div className="flex items-start justify-between border-b border-slate-50 px-5 pb-3.5 pt-5">
          ...
          <button
            disabled={isDeleting}
            onClick={handleClose}
            className="mt-0.5 flex-shrink-0 rounded-lg p-1.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-600 disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        <div className="flex gap-2.5 px-5 pb-5">
          <button
            disabled={isDeleting}
            onClick={handleClose}
            className="flex-1 rounded-xl border border-slate-200 py-2 text-xs font-medium text-slate-500 transition-colors hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Cancel
          </button>
          <button
            disabled={isDeleting}
            onClick={onConfirm}
            className="flex-1 rounded-xl bg-rose-500 py-2 text-xs font-semibold text-white shadow-sm shadow-rose-100 transition-colors hover:bg-rose-600 disabled:cursor-not-allowed disabled:bg-rose-300"
          >
